        ...
        internal static readonly List<Damage> Damages = new List<Damage>()
                                                            {
                                                                new Damage
                                                                    {
                                                                        Champion = Champion.Ashe, DamageType = DamageType.Magical, Floats = new float[] { 250, 425, 600 }, Float = 1f
                                                                    },
                                                                new Damage
                                                                    {
                                                                        Champion = Champion.Draven, DamageType = DamageType.Physical, Floats = new float[] { 175, 275, 375 }, Float = 1.1f
                                                                    },
                                                                new Damage
                                                                    {
                                                                        Champion = Champion.Ezreal, DamageType = DamageType.Magical, Floats = new float[] { 350, 500, 600 }, Float = 1f
                                                                    },
                                                                new Damage
                                                                    {
                                                                        Champion = Champion.Lux, DamageType = DamageType.Magical, Floats = new float[] { 300, 400, 500 }, Float = 0.75f
                                                                    },
                                                                new Damage
                                                                    {
                                                                        Champion = Champion.Karthus, DamageType = DamageType.Magical, Floats = new float[] { 300, 400, 500 }, Float = 0.6f
                                                                    },
                                                                new Damage
                                                                    {
                                                                        Champion = Champion.Pantheon, DamageType = DamageType.Magical, Floats = new float[] { 200, 350, 500 }, Float = 0.5f
                                                                    },
                                                                new Damage
                                                                    {
                                                                        Champion = Champion.Gangplank, DamageType = DamageType.Magical, Floats = new float[] { 50, 70, 90 }, Float = 0.1f
                                                                    },
                                                                new Damage
                                                                    {
                                                                        Champion = Champion.Jinx, DamageType = DamageType.Physical, Floats = new float[] { 25, 35, 45 }, Float = 0.1f
                                                                    },
                                                                new Damage
                                                                    {
                                                                        Champion = Champion.Ziggs, DamageType = DamageType.Magical, Floats = new float[] { 200, 300, 400 }, Float = 0.73f
                                                                    }
                                                            };
                                                               ...
                                                               new Hero
                                                                   {
                                                                       ...
                                                                       AllowedCollisionCount = int.MaxValue, CastDelay = 1000, Speed = 2000, Width = 160,
                                                                       Range = int.MaxValue
                                                                   },
                                                               new Hero
                                                                   {
