namespace KappAzir
{
    ...
    internal class Menus
    {
        ...
        public static void CreateMenu()
        {
            ...
            InsecMenu.CreateCheckBox(" - Use Flash if Possible AoE", "rUseFlash");
            ...
            ComboMenu.CreateCheckBox(" - Use Q If Target Not In Soldiers Range", "qUseAA");
            ComboMenu.CreateSlider("Soldier Count to Cast Q [{0}]", "Qcount", 1, 1, 3);
            ComboMenu.CreateSlider("Q AoE hit [{0}]", "Qaoe", 3, 1, 5);
            ComboMenu.AddSeparator();
            ComboMenu.AddGroupLabel("W Extra Settings");
            ComboMenu.CreateCheckBox(" - Use W If Target Not In Soldiers Range", "wUseAA");
            ComboMenu.CreateCheckBox(" - Save 1 W Stack", "wSave");
            ComboMenu.AddSeparator();
            ComboMenu.AddGroupLabel("E Extra Settings");
            ComboMenu.CreateCheckBox(" - Use E Only if target Killable", "eUsekill");
            ComboMenu.CreateCheckBox(" - E Dive Towers", "eUseDive");
            ComboMenu.CreateSlider("No E if Target Health more than my health by [{0}%]", "eHealth", 35);
            ComboMenu.CreateSlider("No E if Enemies Near target more than [{0}]", "eSave", 3, 1, 5);
            ComboMenu.AddSeparator();
            ...
            ComboMenu.CreateCheckBox(" - Use R Saver", "rUseSave");
            ...
            HarassMenu.CreateCheckBox(" - E Dive Towers", "eUseDive");
            HarassMenu.CreateSlider("No E if Enemies Near target more than [{0}]", "eSave", 3, 1, 5);
            HarassMenu.CreateSlider("Mana must be more than [{0}%] to use Harass spells", "manaSlider", 30);
            ...
            AutoHarassMenu.CreateCheckBox(" - Always AutoAttack with soldiers", "attack");
            AutoHarassMenu.CreateCheckBox(" - E Dive Towers", "eDive");
            ...
            AutoHarassMenu.CreateSlider("Mana must be more than [{0}%] to use AutoHarass spells", "manaSlider", 30);
            ...
            LaneClearMenu.CreateSlider("Mana must be more than [{0}%] to use LaneClear spells", "manaSlider", 30);

            LasthitMenu.AddGroupLabel("Spells");
            LasthitMenu.CreateCheckBox(" - Use Q", "qUse");
            LasthitMenu.AddGroupLabel("Settings");
            LasthitMenu.CreateSlider("Mana must be more than [{0}%] to use LastHit spells", "manaSlider", 30);
            ...
            JungleClearMenu.CreateSlider("Mana must be more than [{0}%] to use JungleClear spells", "manaSlider", 30);
            ...
            KillStealMenu.CreateSlider("Mana must be more than [{0}%] to use Killsteal spells", "manaSlider", 30);
